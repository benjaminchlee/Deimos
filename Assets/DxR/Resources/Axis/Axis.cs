...
namespace DxR
{
    public class Axis : MonoBehaviour
    {
        ...
        private void SetTitlePadding(string titlePadding)
        {
            titleOffset = 0.075f + (float.Parse(titlePadding) * DxR.Vis.SIZE_UNIT_SCALE_FACTOR);
        }
        ...
        private void OrientAlongPositiveX()
        {
            ...
            gameObject.transform.Find("Title").localPosition = new Vector3(0, -titleOffset, 0);
        }
        ...
        private void OrientAlongPositiveZ()
        {
            ...
            gameObject.transform.Find("Title").localPosition = new Vector3(0, -titleOffset, 0);
            gameObject.transform.Find("Title").localEulerAngles = new Vector3(0, 180, 0);
